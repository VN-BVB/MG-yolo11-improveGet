...
256. ultralytics/cfg/models/11/yolo11-C3k2-Strip.yaml
    ...
    使用[AAAI2026 Strip R-CNN](https://arxiv.org/pdf/2501.03775)中的StripBlock改进C3k2.
    项目视频百度云链接:20250205版本更新说明

257. ultralytics/cfg/models/11/yolo11-C3k2-StripCGLU.yaml

    使用[AAAI2026 Strip R-CNN](https://arxiv.org/pdf/2501.03775)中的StripBlock和[TransNeXt CVPR2024](https://github.com/DaiShiResearch/TransNeXt)中的Convolutional GLU改进C3k2.
    项目视频百度云链接:20250205版本更新说明
...
388. ultralytics/cfg/models/11/yolo11-C3k2-LWGA.yaml
    ...
    使用[AAAI2026 LWGANet](https://github.com/lwCVer/LWGANet)中的LWGABlock改进C3k2.(需要看[常见错误和解决方案的第五点](#a))
    项目视频百度云链接:20251008版本更新说明
...
395. ultralytics/cfg/models/11/yolo11-C3k2-RMBC.yaml

    使用[PlainUSR](https://arxiv.org/pdf/2409.13435)中的RepMBConv改进C3k2.
    项目视频百度云链接:20251122版本更新说明

396. ultralytics/cfg/models/11/yolo11-C3k2-RMBC-LA.yaml

    使用[PlainUSR](https://arxiv.org/pdf/2409.13435)中的RepMBConv和Local Importance-based Attention改进C3k2.
    项目视频百度云链接:20251122版本更新说明

397. ultralytics/cfg/models/11/yolo11-C3k2-IEL.yaml

    使用[CVPR2025 HVI](https://arxiv.org/pdf/2502.20272)中的IEL改进C3k2.
    项目视频百度云链接:20251219版本更新说明

398. ultralytics/cfg/models/11/yolo11-C3k2-SFMB.yaml

    使用[TIP2025 SFMB](https://arxiv.org/pdf/2511.06593v1)中的SFMB改进C3k2.<编译教程请看百度云视频-20240219版本更新说明>(需要看[常见错误和解决方案的第五点](#a))
    项目视频百度云链接:20251219版本更新说明

399. ultralytics/cfg/models/11/yolo11-LCA.yaml

    使用[CVPR2025 HVI](https://arxiv.org/pdf/2502.20272)中的LCA改进yolo11-neck.
    项目视频百度云链接:20251219版本更新说明

400. ultralytics/cfg/models/11/yolo11-HFFE.yaml
